                       ...
                       <div>
                            ...
                            <select name="ejecutivo_id" 
                                ...
                                <?php $__currentLoopData = $ejecutivos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ejecutivo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($ejecutivo->id); ?>" <?php echo e(old('ejecutivo_id') == $ejecutivo->id ? 'selected' : ''); ?>>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\FINSA\resources\views/plazas/create.blade.php ENDPATH**/ ?>