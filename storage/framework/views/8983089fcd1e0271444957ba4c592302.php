...
<?php $component->withAttributes([]); ?>
    ...
    <?php if(in_array(auth()->user()->role, [\App\Enums\UserRole::ADMIN, \App\Enums\UserRole::EJECUTIVO])): ?>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            searchInput.addEventListener('input', function (e) {
                ...
                timeout = setTimeout(() => {
                    ...
                    fetch(`<?php echo e(route('clientes.index')); ?>?search=${encodeURIComponent(query)}`, {
...
<?php endif; ?><?php /**PATH D:\laragon\www\Prueba1\resources\views/clientes/index.blade.php ENDPATH**/ ?>